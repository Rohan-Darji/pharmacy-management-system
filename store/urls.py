...
urlpatterns = [
    ...
    path("sellmedicine/<int:id>/", views.sellmedicine, name="SellMedicine"),
    path("records/", views.records, name="Records"),
    path("delete/<int:id>/", views.delete_med, name="DeleteMed"),
    path("delete_rec/<int:id>/", views.delete_rec, name="DeleteRec"),
    path("<int:id>/", views.update_med, name="UpdateMed"),
